...
function initDatatable_del(idTabla)
{
    $('#'+idTabla).DataTable( {
        "autoWidth":false,
        "responsive":true,
...
function initDatatable(idTabla)
{
    $('#'+idTabla).DataTable({
        ...
        "responsive": true,
        "ordering": false,
        "pageLength": 6, // <- Esta línea define que se muestren 6 registros por página al inicio
        "lengthMenu": [[5, 6, 10, 25, -1], [5, 6, 10, 25, "Todos"]],
        "language": {
